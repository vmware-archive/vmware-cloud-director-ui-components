...
## [Unreleased]
- Fix visibility updates getting lost when `actionItem.availability` is an observable created from hot observable like
a Subject
...
## [3.0.0-dev.3]
### Added
- Ability to disable datgrid rows from being selectable
