 ...
 */
/** @type {?} */
const STACKBLITZ_INFO = new _angular_core__WEBPACK_IMPORTED_MODULE_0__["InjectionToken"]('StackBlitz Template information');
/** @type {?} */
...
class StackBlitzWriterService {
    ...
    openStackBlitz(entry) {
        return Object(tslib__WEBPACK_IMPORTED_MODULE_7__["__awaiter"])(this, void 0, void 0, function* () {
            ...
            return _stackblitz_sdk__WEBPACK_IMPORTED_MODULE_8__["default"].openProject(project, openOptions);
        });
    }
    /**
     * @private
    ...
    fetchSbTemplate() {
        return Object(tslib__WEBPACK_IMPORTED_MODULE_7__["__awaiter"])(this, void 0, void 0, function* () {
            ...
            /** @type {?} */
            const vm = yield _stackblitz_sdk__WEBPACK_IMPORTED_MODULE_8__["default"].embedProjectId(iframeContainer, this.stackBlitzInfo.projectName, { view: 'editor' });
 ...
 * @type {?}
 */
const DOCUMENTATION_DATA = new _angular_core__WEBPACK_IMPORTED_MODULE_0__["InjectionToken"]('DocLibModule.forRoot() CompoDocRetrieverService doc jsons.');
/**
 * Token that makes Stqckblitz JSON data available to factory functions
 * @type {?}
 */
const STACKBLITZ_DATA = new _angular_core__WEBPACK_IMPORTED_MODULE_0__["InjectionToken"]('DocLibModule.forRoot() StackBlitz template JSON data');
/**
...
class MessageFormatTranslationService extends TranslationService {
    ...
    constructor(preferredLocale, fallbackLocale, translationLoader, combinedTranslations) {
        ...
        this.translationSet = new rxjs__WEBPACK_IMPORTED_MODULE_2__["BehaviorSubject"]({});
    }
    /**
    ...
    formatString(locale, key, translationMap, translations) {
        ...
        /** @type {?} */
        const message = new messageformat__WEBPACK_IMPORTED_MODULE_1___default.a(locale).compile(template);
 ...
 */
/** @type {?} */
const BOOTSTRAP_DETAILS = new _angular_core__WEBPACK_IMPORTED_MODULE_0__["InjectionToken"]('BOOTSTRAP_DETAILS');
 ...
 * if clipping has occurred.
 */
let CliptextComponent = class CliptextComponent {
    constructor(changeDetector) {
        this.changeDetector = changeDetector;
        this._inline = false;
        this._size = 'md';
...
let CliptextModule = class CliptextModule {
};
 ...
 * Invoking `{{ obj | nestedProperty: 'a.b.c' }}` in a template produces c
 */
let NestedPropertyPipe = class NestedPropertyPipe {
    constructor(localeId) {
        this.localeId = localeId;
    }
    transform(item, property) {
...
const declarations = [_nested_property_pipe__WEBPACK_IMPORTED_MODULE_2__["NestedPropertyPipe"]];
 ...
 *  - Converts the data that is fetched by the caller into a CSV
 */
let DataExporterComponent = class DataExporterComponent {
    constructor(csvExporterService) {
        this.csvExporterService = csvExporterService;
        /**
         * List of columns that can be exported, user may deselect some before sending the download request
...
let DatagridComponent = class DatagridComponent {
    ...
    updateSelectedItems() {
        if (this._selectionType === GridSelectionType.Single) {
            // Tries to find the currently selected item. If it isn't found, clears the selection.
            const found = this.items.find((item, itemIndex) => this.trackBy(itemIndex, item) ===
                this.trackBy(this.items.indexOf(this.datagrid.selection.currentSingle), this.datagrid.selection.currentSingle));
            if (!found) {
                this.datagrid.selection.currentSingle = undefined;
            }
            ...
            if (this.datagrid.selection.current) {
                this.datagrid.selection.current = this.datagrid.selection.current.filter((selected, selectedIndex) => {
                    const found = this.items.find((item, itemIndex) => this.trackBy(itemIndex, item) === this.trackBy(selectedIndex, selected));
                    return found;
                });
            }
        }
...
const directives = [_datagrid_component__WEBPACK_IMPORTED_MODULE_4__["DatagridComponent"], _directives_component_renderer_outlet_directive__WEBPACK_IMPORTED_MODULE_5__["ComponentRendererOutletDirective"]];
const pipes = [_pipes_function_renderer_pipe__WEBPACK_IMPORTED_MODULE_8__["FunctionRendererPipe"]];
const renderers = [_renderers_bold_text_renderer_component__WEBPACK_IMPORTED_MODULE_9__["BoldTextRendererComponent"]];
...
DatagridModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
        ...
        declarations: [...directives, ...renderers, ...pipes],
        providers: [],
        exports: [_datagrid_component__WEBPACK_IMPORTED_MODULE_4__["DatagridComponent"], ...renderers],
        entryComponents: [...renderers],
    })
], DatagridModule);
 ...
 *
 */
let ComponentRendererOutletDirective = class ComponentRendererOutletDirective {
    constructor(viewContainerRef, cfr) {
        this.viewContainerRef = viewContainerRef;
        this.cfr = cfr;
    }
 ...
 * properties of an object
 */
let FunctionRendererPipe = class FunctionRendererPipe {
    transform(item, renderer) {
        if (!item || !renderer) {
            return null;
        }
 ...
 *     ];
 */
let BoldTextRendererComponent = class BoldTextRendererComponent {
};
tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Input"])()
...
let AppComponent = class AppComponent {
    constructor(router) {
         ...
         * on the side navigation
         */
        this.sideNavEntries = _vcd_ui_doc_lib__WEBPACK_IMPORTED_MODULE_2__["Documentation"].getAllEntries().map((entry) => ({
            title: entry.displayName,
            path: entry.urlSegment,
        }));
        /**
...
const ASSET_URL = new _angular_core__WEBPACK_IMPORTED_MODULE_1__["InjectionToken"]('ASSETS');
/**
 ...
 */
const docJson1 = _gen_components_doc_documentation_json__WEBPACK_IMPORTED_MODULE_15__;
const docJson2 = _gen_examples_doc_documentation_json__WEBPACK_IMPORTED_MODULE_16__;
const sbInfo = {
    templateId: 'vcd-ui-cc-starter-clarity-v8-yhe4yg',
    projectName: 'VMware Cloud Director UI Components',
    moduleFinder(componentName) {
        return componentName.replace('ExampleComponent', 'ExampleModule');
    },
};
...
let CliptextDatagridExampleComponent = class CliptextDatagridExampleComponent {
};
...
let CliptextDatagridExampleModule = class CliptextDatagridExampleModule {
};
...
let CliptextDynamicInlineExampleComponent = class CliptextDynamicInlineExampleComponent {
    constructor() {
...
let CliptextDynamicInlineExampleModule = class CliptextDynamicInlineExampleModule {
};
...
let CliptextExamplesModule = class CliptextExamplesModule {
};
...
let DataExporterExampleComponent = class DataExporterExampleComponent {
    constructor() {
        this.exportColumns = [
            { fieldName: 'name', displayName: 'Name' },
            { fieldName: 'desc', displayName: 'Description' },
...
let DataExporterExampleModule = class DataExporterExampleModule {
};
...
let DataExporterExamplesModule = class DataExporterExamplesModule {
};
 ...
 * A component that holds an example of the css classes per row capability.
 */
let DatagridCssClassesExampleComponent = class DatagridCssClassesExampleComponent {
    /**
     * A component that holds an example of the css classes per row capability.
     */
    constructor() {
    ...
    clrDatarowCssClassGetter(entity, index) {
        if (entity.value === 'warn') {
            return 'yellow-row';
        }
        else if (entity.value === 'error') {
...
let DatagridCssClassesExampleModule = class DatagridCssClassesExampleModule {
};
 ...
 * A component that holds an example of the show/hide columns capability.
 */
let DatagridDetailRowExampleComponent = class DatagridDetailRowExampleComponent {
    /**
     * A component that holds an example of the show/hide columns capability.
     */
    constructor() {
...
let DatagridDetailRowExampleModule = class DatagridDetailRowExampleModule {
};
 ...
 * A component that holds an example of the pagination capability.
 */
let DatagridPaginationExampleComponent = class DatagridPaginationExampleComponent {
    /**
     * A component that holds an example of the pagination capability.
     */
    constructor() {
...
let DatagridPagionationExampleModule = class DatagridPagionationExampleModule {
};
 ...
 * Allows for multi, single, or no selection.
 */
let DatagridRowSelectExampleComponent = class DatagridRowSelectExampleComponent {
    /**
     * Logs the selected row to the console when the selection changes.
     * Allows for multi, single, or no selection.
     */
...
let DatagridRowSelectExampleModule = class DatagridRowSelectExampleModule {
};
 ...
 * A component that holds an example of the show/hide columns capability.
 */
let DatagridShowHideExampleComponent = class DatagridShowHideExampleComponent {
    /**
     * A component that holds an example of the show/hide columns capability.
     */
    constructor() {
...
let DatagridShowHideExampleModule = class DatagridShowHideExampleModule {
};
 ...
 * A component that holds an example of the sorting columns capability.
 */
let DatagridSortExampleComponent = class DatagridSortExampleComponent {
    /**
     * A component that holds an example of the sorting columns capability.
     */
    constructor() {
...
let DatagridSortExampleModule = class DatagridSortExampleModule {
};
...
let DatagridThreeRenderersExampleComponent = class DatagridThreeRenderersExampleComponent {
    constructor() {
        this.gridData = {
            items: [],
        };
...
let DatagridThreeRenderersExampleModule = class DatagridThreeRenderersExampleModule {
};
 ...
 */
let DatagridExamplesModule = class DatagridExamplesModule {
};
